...
*/
    ...
    app.get("/polls/:id", function(req,res){
        ...
        db.collection(POLLS_COLLECTION).findOne({_id: new ObjectID(req.params.id)}, function(err, doc){
    ...
    app.put("/polls/:id", function(req,res){
        ...
        db.collection(POLLS_COLLECTION).updateOne({_id: new ObjectID(req.params.id)}, updatePoll, function(err,doc) {
    ...
    app.delete("/polls/:id", function(req,res){
        ...
        db.collection(POLLS_COLLECTION).deleteOne({_id: new ObjectID(req.params.id)}, function(err,doc){
